...
const About= ()=> {
	...
	<hr/>
		...
		<h1 className='text-[26px] text-[#167396] font-serif font-bold'>ABOUT US</h1>
		...
		<section className='min-h-[200px] font-sans w-[100%] bg-[grey]mb-[20px] p-[3%] max-h-[400px]'>
		<h1 className='text-[26px] text-[#167396] font-serif font-bold'>EXPERIENCE AND EXPERTISE</h1>
