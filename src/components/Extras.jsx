...
const Extras = ()=>{
	...
	<section className='flex flex-col md:flex-row md:justify-center flex-wrap gap-3'>
		<section className='p-4 md:max-w-[45%]'>
			<h1 className='text-[26px] font-serif font-bold'>HOW IT WORKS</h1>
			<p>Submitting your essay for evaluation is easy with CritiWrite. Follow these simple steps:</p>
			<p>1. Go to the Evaluation [Hyperlink] page</p>
		...
		<section className='p-4 md:max-w-[45%]'>
			<h1 className='text-[26px] font-serif font-bold'>Evaluation Process and Turnaround Time</h1>
		...
		<section className='p-4 md:w-[60%]'>
			<h1 className='text-[26px] font-serif font-bold'>Accuracy</h1>
