  ...
  return (
    <section>
      <div className="relative">
        <img src={logo} alt="logo" className="w-[100px] animate-slide-down" />
        <div className="relative">
...
const heroStyles = {
  slideShow:
    "w-[393px] h-[679px] md:w-[900px] opacity-25 md:opacity-25 md:h-[879px] lg:h-[900px] ",
  headerWrapper:
    "absolute top-[80px] left-0 w-full flex flex-col items-center md:absolute md:top-[50%] md:left-[50%] md:transform md:-translate-x-1/2 md:-translate-y-1/2 md:text-center lg:absolute lg:top-[50%] lg:left-[75%] lg:transform lg:-translate-x-1/2 lg:-translate-y-1/2 lg:text-center",
  header1Styles:
